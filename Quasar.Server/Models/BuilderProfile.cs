...
namespace Quasar.Server.Models
{
    public class BuilderProfile
    {
        ...
        // Keylogger functionality has been removed
        public bool Keylogger
        {
            get
            {
                return false; // Always return false as keylogger is disabled
            }
            set
            {
                // Do nothing as keylogger functionality has been removed
            }
        }
